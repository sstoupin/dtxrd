# -*- coding: utf-8 -*-
#
# info documentation build configuration file, created by
...
html_use_smartypants = (False, 'html')
smartquotes = False # For sphinx >=1.6
...
latex_documents = [
  ('index', 
   info.__package_name__+'.tex', 
   info.__package_name__+u' Documentation',
   info.__author__, 
   'manual'),
]
